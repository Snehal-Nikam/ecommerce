              ...
              <div >
                ...
                <div>
                  <h5 v-show="editOffset != 'name'">
                    ...
                    <a href="#" @click.prevent="startEditing('name')" class="px-2"><i class="fa fa-pen" style="color: grey;"></i></a>
                  </h5>
                  <div v-show="editOffset=='name'" style="display : inline-block">
                    <b>First Name : </b> <input  type="text"
                                                 :id = "'item-user-name'"
                                                 class="form-control" v-model="profile.firstName">
                    <b>Last Name : </b><input type="text"
                                              :id = "'item-user-name'"
                                              class="form-control" v-model="profile.lastName">
                  </div>
                </div>
              </div>
              <div class="pt-2">
                ...
                <div class="m-3 form-row justify-content-center">
                  <b> Email : </b> <span v-show="editOffset != 'email'">{{profile.email}}
                           <a href="#" @click.prevent="startEditing('email')" class="px-2"><i class="fa fa-pen" style="color: grey"></i></a></span>
                  <span v-show="editOffset=='email'">
                           <input  type="text"
                                   :id = "'item-user-email'"
                                   class="form-control" v-model= "profile.email">
                           </span>
                  <br/>
                </div>
                <div class="m-3 form-row justify-content-center">
                  <b> Phone : </b><span v-show="editOffset != 'phone'">{{profile.phone}}
                           <a href="#" @click.prevent="startEditing('phone')" class="px-2"><i class="fa fa-pen" style="color: grey"></i></a></span>
                  <span v-show="editOffset=='phone'" >
                           <input  type="text"
                                   :id = "'item-user-phone'"
                                   class="form-control" v-model="profile.phone">
                           </span>
                </div>
              </div>
